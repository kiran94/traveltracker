...
use TravelTracker\Trip;
use TravelTracker\TripQuery;
...
class TripTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TravelTracker.Map.TripTableMap';
     ...
     */
    const OM_CLASS = '\\TravelTracker\\Trip';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TravelTracker.Trip';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\TravelTracker\\Trip');
    ...
    {
        $this->addRelation('Location', '\\TravelTracker\\Location', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':TripID',
    1 => ':ID',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TravelTracker\Trip) { // it's a model object
